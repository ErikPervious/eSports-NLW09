...
function App() {
  return (
    <div className="max-w-[800px] mx-auto flex flex-col items-center my-20">
      ...
      <div className="grid grid-cols-6 gap-6 mt-12">
        ...
        <a href="" className="relative rounded-lg overflow-hidden">
          ...
          <div className="w-full pt-16 pb-4 px-4 bg-game-gradient absolute bottom-0 left-0 right-0">
            <strong className="text-sm font-bold text-white block">Counter Strike Global Offensive</strong>
            <span className="text-zinc-300 text-sm block mt-1">32 Anúncios</span>
          </div>
        </a>
        <a href="" className="relative rounded-lg overflow-hidden">
        ...
        <a href="" className="relative rounded-lg overflow-hidden">
          ...
          <div className="w-full pt-16 pb-4 px-4 bg-game-gradient absolute bottom-0 left-0 right-0">
            <strong className="text-sm font-bold text-white block">WarCraft</strong>
      ...
      <div className="pt-1 bg-nlw-gradient self-stretch rounded-lg mt-8 overflow-hidden">
        <div className="bg-[#2A2634] px-8 py-6 flex justify-between items-center">
          <div>
            <strong className="text-2xll text-white font-black block">Não encontrou seu duo?</strong>
